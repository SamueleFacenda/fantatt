...
module.exports = {
  ...
  appNodeModules: resolveApp('.yarn'),
  appWebpackCache: resolveApp('.yarn/.cache'),
  appTsBuildInfoFile: resolveApp('.yarn/.cache/tsconfig.tsbuildinfo'),
  swSrc: resolveModule(resolveApp, 'frontend/service-worker'),
  publicUrlOrPath,
};
